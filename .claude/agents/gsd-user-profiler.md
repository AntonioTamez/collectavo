...
<reference>
@C:/ATS/Git/collectavo/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `C:/ATS/Git/collectavo/.claude/get-shit-done/references/user-profiling.md` to load:
