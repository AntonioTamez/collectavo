...
<required_reading>
@C:/ATS/Git/collectavo/.claude/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
@C:/ATS/Git/collectavo/.claude/get-shit-done/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = C:/ATS/Git/collectavo/.claude
                  → checks C:/ATS/Git/collectavo/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = C:/ATS/Git/collectavo/.claude/get-shit-done
                  → writes to C:/ATS/Git/collectavo/.claude/get-shit-done/hooks/
...
@C:/ATS/Git/collectavo/.claude/get-shit-done/references/thinking-models-debug.md
...
- Read @C:/ATS/Git/collectavo/.claude/get-shit-done/references/common-bug-patterns.md
