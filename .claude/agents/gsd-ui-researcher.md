...
Use template from `C:/ATS/Git/collectavo/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `C:/ATS/Git/collectavo/.claude/get-shit-done/templates/UI-SPEC.md`
