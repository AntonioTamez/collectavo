...
Reference full template: `C:/ATS/Git/collectavo/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `C:/ATS/Git/collectavo/.claude/get-shit-done/templates/state.md`.
