...
Key references:
- @C:/ATS/Git/collectavo/.claude/get-shit-done/references/ui-brand.md (display patterns)
- @C:/ATS/Git/collectavo/.claude/agents/gsd-user-profiler.md (profiler agent definition)
- @C:/ATS/Git/collectavo/.claude/get-shit-done/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="C:/ATS/Git/collectavo/.claude/get-shit-done/USER-PROFILE.md"
...
```bash
cp "C:/ATS/Git/collectavo/.claude/get-shit-done/USER-PROFILE.md" "C:/ATS/Git/collectavo/.claude/USER-PROFILE.backup.md"
```
...
✓ Stores profile at C:/ATS/Git/collectavo/.claude/get-shit-done/USER-PROFILE.md
...
- The user-profiling reference doc at `C:/ATS/Git/collectavo/.claude/get-shit-done/references/user-profiling.md`
...
Reference: @C:/ATS/Git/collectavo/.claude/get-shit-done/references/user-profiling.md
...
Display: "✓ Profile written to C:/ATS/Git/collectavo/.claude/get-shit-done/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global CLAUDE.md" -- "Add profile to C:/ATS/Git/collectavo/.claude/CLAUDE.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at C:/ATS/Git/collectavo/.claude/get-shit-done/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated /gsd-dev-preferences at C:/ATS/Git/collectavo/.claude/skills/gsd-dev-preferences/SKILL.md"
...
Display: "✓ Added profile section to C:/ATS/Git/collectavo/.claude/CLAUDE.md"
...
```bash
BACKUP_PATH="C:/ATS/Git/collectavo/.claude/USER-PROFILE.backup.md"
```
...
Your profile:    C:/ATS/Git/collectavo/.claude/get-shit-done/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   C:/ATS/Git/collectavo/.claude/skills/gsd-dev-preferences/SKILL.md
  ✓ CLAUDE.md section       ./CLAUDE.md
  ✓ Global CLAUDE.md        C:/ATS/Git/collectavo/.claude/CLAUDE.md
```
