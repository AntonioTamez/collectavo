...
```
Agent(
  prompt="Read C:/ATS/Git/collectavo/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/ATS/Git/collectavo/.claude/get-shit-done/templates/VALIDATION.md`
