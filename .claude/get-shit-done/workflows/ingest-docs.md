...
```bash
INIT=$(node "C:/ATS/Git/collectavo/.claude/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "C:/ATS/Git/collectavo/.claude/get-shit-done/bin/gsd-tools.cjs" commit \
