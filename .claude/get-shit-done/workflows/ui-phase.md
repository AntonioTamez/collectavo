...
```markdown
Read C:/ATS/Git/collectavo/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: C:/ATS/Git/collectavo/.claude/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read C:/ATS/Git/collectavo/.claude/agents/gsd-ui-checker.md for instructions.
