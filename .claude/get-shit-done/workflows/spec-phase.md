...
```bash
INIT=$(node "C:/ATS/Git/collectavo/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @C:/ATS/Git/collectavo/.claude/get-shit-done/templates/spec.md.
