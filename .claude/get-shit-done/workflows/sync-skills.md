...
INSTALL_JS_GLOBAL="C:/ATS/Git/collectavo/.claude/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node C:/ATS/Git/collectavo/.claude/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
