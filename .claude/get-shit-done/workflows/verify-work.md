...
<template>
@C:/ATS/Git/collectavo/.claude/get-shit-done/templates/UAT.md
</template>
...
**MVP-mode UAT framing.** When `MVP_MODE=true`, follow the rules in `@C:/ATS/Git/collectavo/.claude/get-shit-done/references/verify-mvp-mode.md`. Briefly:
...
Read and follow `C:/ATS/Git/collectavo/.claude/get-shit-done/workflows/transition.md`.
...
- Follow @C:/ATS/Git/collectavo/.claude/get-shit-done/workflows/diagnose-issues.md
