...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `C:/ATS/Git/collectavo/.claude/skills/.gsd-surface.json`
...
```bash
# Claude Code
RUNTIME_CONFIG_DIR=C:/ATS/Git/collectavo/.claude/skills

# Resolve commandsDir and agentsDir
COMMANDS_DIR=C:/ATS/Git/collectavo/.claude/commands/gsd
AGENTS_DIR=C:/ATS/Git/collectavo/.claude/agents
```
...
<execution_context>
Surface state file: `C:/ATS/Git/collectavo/.claude/skills/.gsd-surface.json`
Install profile marker: `C:/ATS/Git/collectavo/.claude/skills/.gsd-profile`
Engine module: `C:/ATS/Git/collectavo/.claude/get-shit-done/bin/lib/surface.cjs`
Cluster definitions: `C:/ATS/Git/collectavo/.claude/get-shit-done/bin/lib/clusters.cjs`
</execution_context>
